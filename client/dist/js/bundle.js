...
var HistoryViewer = function (_Component) {
  ...
  _createClass(HistoryViewer, [{
    ...
    value: function getVersions() {
      ...
      var nodes = versions && versions.snapshotHistory && versions.snapshotHistory.nodes ? versions.snapshotHistory.nodes : [];
...
var createSnapshotsQuery = function createSnapshotsQuery(typeName, isPreviewable) {
  return (0, _graphqlTag2.default)(_templateObject, typeName, typeName, typeName, isPreviewable ? 'absoluteLink' : '', isPreviewable ? 'absoluteLink' : '');
};
