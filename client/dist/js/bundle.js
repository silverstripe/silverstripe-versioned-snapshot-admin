...
var _snapshotsQuery = __webpack_require__("./client/src/graphql/snapshotsQuery.js");

var _snapshotsQuery2 = _interopRequireDefault(_snapshotsQuery);
...
exports.default = function () {
  ...
  _Injector2.default.transform('snapshot-history', function (updater) {
    updater.component('SnapshotViewer.pages-controller-cms-content', _snapshotsQuery2.default);
  });
};
...
var _ViewModeActions = __webpack_require__(9);
...
var HistoryViewerSnapshotState = function (_VersionedState) {
  ...
  _createClass(HistoryViewerSnapshotState, [{
    ...
    value: function getPublishedState() {
      ...
      var description = ActivityDescription.charAt(0).toLowerCase() + ActivityDescription.substring(1);
...
/***/ "./client/src/graphql/snapshotsQuery.js":
/***/ (function(module, exports, __webpack_require__) {
...
_jquery2.default.entwine('ss', function ($) {
  $('.js-injector-boot .snapshot-history-viewer__container').entwine({
    onmatch: function onmatch() {
      ...
      var HistoryViewerComponent = (0, _Injector.loadComponent)('SnapshotViewer', context);
